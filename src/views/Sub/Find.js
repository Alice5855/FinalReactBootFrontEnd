                ...
                <div className="w-100">
                    ...
                    <div>
                        <div className="container col-xxl-8 px-4 py-5 ">
                            <div className="row flex-lg-row align-items-center g-5 py-5 kfont1" style={textAlign}>
                                <div className="display-5 fw-bold lh-1 mt0 find-subTitle fs-6">찾 아 오 는 길</div>
                                <h1 className="display-5 fw-bold lh-1 mt-3 find-Title">방문을 환영합니다!</h1>
                                ...
                                <div className="col-lg-6 mapCover mt0">
